...
func TestNewChan(t *testing.T) {
	...
	expectPanic(t, func() {
		thp2.NewChan[*int](-1)
	}, thp2.ErrChanBatchSize)
	expectPanic(t, func() {
		thp2.NewChan[*int](0)
	}, thp2.ErrChanBatchSize)
	_, _ = thp2.NewChan[*int](1)
}

func TestPerefetch(t *testing.T) {
	t.Parallel()

	ch, chCloser := thp2.NewChan[int](3)
	defer chCloser()
...
func TestNonBlockingFlush(t *testing.T) {
	...
	// thp2.Chan internally has capacity == runtime.NumCPU
...
func TestNonBlockingFetch(t *testing.T) {
	...
	// New channel
	ch, chCloser := thp2.NewChan[string](3)
...
func runPrimitiveChanTest(t *testing.T, batchSize int, producersCnt int, consumersCnt int, itemsPerProducer int) {
	ch, chCloser := thp2.NewChan[int](batchSize)
