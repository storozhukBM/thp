...
func TestNewChan(t *testing.T) {
	...
	expectPanic(t, func() {
		thp3.NewChan[*int](-1)
	}, thp3.ErrChanBatchSize)
	expectPanic(t, func() {
		thp3.NewChan[*int](0)
	}, thp3.ErrChanBatchSize)
	_, _ = thp3.NewChan[*int](1)
}

func TestPerefetch(t *testing.T) {
	t.Parallel()

	ch, chCloser := thp3.NewChan[int](3)
	defer chCloser()
...
func TestNonBlockingFlush(t *testing.T) {
	...
	// thp3.Chan internally has capacity == runtime.NumCPU
...
func TestNonBlockingFetch(t *testing.T) {
	...
	// New channel
	ch, chCloser := thp3.NewChan[string](3)
...
func runPrimitiveChanTest(t *testing.T, batchSize int, producersCnt int, consumersCnt int, itemsPerProducer int) {
	ch, chCloser := thp3.NewChan[int](batchSize)
